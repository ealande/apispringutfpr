...
public class TaskIntegrationTest {
    ...
    private TaskMemoryGateway taskGateway = new TaskMemoryGateway();
    private CreateTask createTask = new CreateTask(taskGateway);
    private CompleteTask completeTask = new CompleteTask(taskGateway);
